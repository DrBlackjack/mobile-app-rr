...
export default {
    components: {
        IonItem, IonLabel, IonList, IonSelectOption, IonSelect
    },
    data () {
        return{
            categorieArray: [{}],
...
<script type="ts">
/* eslint-disable */
import { IonItem, IonLabel, IonList, IonSelectOption, IonSelect, IonButtons, IonButton  } from '@ionic/vue';
import axios from 'axios';


export default {
    components: {
        IonItem, IonLabel, IonList, IonSelectOption, IonSelect, IonButtons, IonButton
    },
    data () {
        return{
            categorieArray: [{}],
